...
#SBATCH --output=slurm_output/sgr/euclidean/norm_array_%A_%a.out 
#SBATCH --error=slurm_output/sgr/euclidean/norm_array_%A_%a.err  

PROJECT_ROOT="$HOME/Spherical-Flow-Matching"
TASKS_FILE="$PROJECT_ROOT/tasks/sgr_euclidean_norm.txt"
...
mkdir -p "$PROJECT_ROOT/metrics_links/sgr/euclidean"
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    LOCAL_SYMLINK_DIR="$PROJECT_ROOT/metrics_links/sgr/euclidean"
...
# If the exit code is not 0, the job failed.
    ...
    mkdir -p "$PROJECT_ROOT/failed_tasks/sgr/euclidean"
    cp "$PROJECT_ROOT/slurm_output/sgr/euclidean/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" "$PROJECT_ROOT/failed_tasks/sgr/euclidean/"
    cp "$PROJECT_ROOT/slurm_output/sgr/euclidean/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err" "$PROJECT_ROOT/failed_tasks/sgr/euclidean/"
