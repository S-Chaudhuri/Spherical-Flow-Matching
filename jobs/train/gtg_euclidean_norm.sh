...
mkdir -p slurm_output/gtg/euclidean 
mkdir -p failed_tasks/gtg/euclidean
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    LOCAL_SYMLINK_DIR="metrics_links/gtg/euclidean"
...
# If the exit code is not 0, the job failed.
    ...
    cp "/slurm_output/sgr/euclidean/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" /failed_tasks/gtg/euclidean/
    cp "/slurm_output/sgr/euclidean/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err" /failed_tasks/gtg/euclidean/
