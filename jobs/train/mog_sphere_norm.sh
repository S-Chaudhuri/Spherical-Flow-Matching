...
mkdir -p slurm_output/mog/sphere 
mkdir -p failed_tasks/mog/sphere
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    LOCAL_SYMLINK_DIR="metrics_links/mog/sphere"
...
# If the exit code is not 0, the job failed.
    ...
    cp "/slurm_output/mog/sphere/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" /failed_tasks/mog/sphere/
    cp "/slurm_output/mog/sphere/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err" /failed_tasks/mog/sphere/
