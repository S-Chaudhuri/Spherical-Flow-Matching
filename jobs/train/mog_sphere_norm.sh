...
#SBATCH --array=1-120               
#SBATCH --output=/scratch-shared/%u/output/mog/sphere/norm_array_%A_%a.out 
#SBATCH --error=/scratch-shared/%u/logs/mog/sphere/norm_array_%A_%a.err  

# Create necessary directories
mkdir -p /scratch-shared/$USER/logs/mog/sphere 
mkdir -p /scratch-shared/$USER/output/mog/sphere 
mkdir -p /scratch-shared/$USER/failed_tasks/mog/sphere
...
if [ $EXIT_CODE -ne 0 ]; then
    ...
    cp "/scratch-shared/$USER/output/mog/sphere/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" /scratch-shared/$USER/failed_tasks/mog/sphere/
    cp "/scratch-shared/$USER/logs/mog/sphere/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err" /scratch-shared/$USER/failed_tasks/mog/sphere/
