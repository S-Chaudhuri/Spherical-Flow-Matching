...
#SBATCH --array=1-120               
#SBATCH --output=/scratch-shared/%u/output/gtg/poincare/norm_array_%A_%a.out 
#SBATCH --error=/scratch-shared/%u/logs/gtg/poincare/norm_array_%A_%a.err  

# Create necessary directories
mkdir -p /scratch-shared/$USER/logs/gtg/poincare 
mkdir -p /scratch-shared/$USER/output/gtg/poincare 
mkdir -p /scratch-shared/$USER/failed_tasks/gtg/poincare
...
if [ $EXIT_CODE -ne 0 ]; then
    ...
    cp "/scratch-shared/$USER/output/gtg/poincare/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" /scratch-shared/$USER/failed_tasks/gtg/poincare/
    cp "/scratch-shared/$USER/logs/gtg/poincare/norm_array_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err" /scratch-shared/$USER/failed_tasks/gtg/poincare/
